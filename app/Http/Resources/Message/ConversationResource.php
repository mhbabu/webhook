...
class ConversationResource extends JsonResource
{
    public function toArray($request): array
    {
        return [
            ...
            'last_message_at' => $this->lastMessage?->created_at
                ? $this->lastMessage->created_at->toDateTimeString() . ' UTC'
                : null,

            'last_message_info' => $this->lastMessage ? [
                'last_message_sender' => $this->lastMessage->sender_type === 'App\Models\User'
                    ? 'agent'
                    : 'customer',
